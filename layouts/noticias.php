<div id="contentNoticias">
    <div id="containerNoticias">
        <div id="contentTitNoticia">
            <h2 class="titNoticia">TITULO NOTICIA</h2>
        </div>
        <div id="contentTextNoticia">
            <p class="textoNoticia">Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. Aenean massa. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. </p>
        </div>
    </div>
</div>
<div id="contentNoticiasImgs">
    <div id="containerNoticiasImgs">
        <div id="contentNoticiaConImg">
            <div id="containerNoticiaConImg">
        ...
        <div id="contentNoticiaConImg">
            <div id="containerNoticiaConImg">
                <div id="contentNoticiasSidebar">
                    <div id="contentNoticiasSidebarImg">
                        <img class="imgNoticiaSide" src="img/noticia3.jpg" alt="noticia3" />
                    </div>
                ...
                <div id="contentNoticiasSidebar">
                    <div id="contentNoticiasSidebarImg">
                        <img class="imgNoticiaSide" src="img/noticia4.jpg" alt="noticia4" />
                    </div>
                    <div id="contentNoticiasSidebarText">
                        <h4 class="titNoticiaSide">TITULO NOTICIA</h4>
                        <p class="textoNoticiaSide">Lorem ipsum dolor sit amet, consectetuer adipiscing elit.</p>                    
                ...
                <div id="contentNoticiasSidebar">
                    <div id="contentNoticiasSidebarImg">
                        <img class="imgNoticiaSide" src="img/noticia5.jpg" alt="noticia5" />
                    </div>
                    <div id="contentNoticiasSidebarText">
                        <h4 class="titNoticiaSide">TITULO NOTICIA</h4>
                        <p class="textoNoticiaSide">Lorem ipsum dolor sit amet, consectetuer adipiscing elit.</p>                    
